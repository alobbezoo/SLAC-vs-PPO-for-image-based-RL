...
class SlacAlgorithm:
    ...
    def __init__(
        ...
        print("state_shape is: ", state_shape)
        ...
        # Target entropy is -|A|.action_repeat
    ...
    def step(self, env, ob, t, is_random):
        ...
        # render3 = np.moveaxis(state, 0, 2)
        # print("shape: ", np.shape(render3))
        # print("max: ", np.amax(render3))
        # print("min: ", np.amin(render3))
        # print("REWARD is: ", reward)
        # print("type render 3: ", type(render3))
        # matplotlib.image.imsave(image_compress, render3)
        # time.sleep(0.5)
